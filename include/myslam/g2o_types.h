...
#include <g2o/core/optimization_algorithm_levenburg.h>
#include <g2o/core/robust_kernel_impl.h>
#include <g2o/core/solver.h>
#include <g2o/core/sparse_optimizer.h>
#include <g2o/solvers/csparse/linear_solver_csparse.h>
#include <g2o/solvers/dense/linear/_solver_dense.h>
...
public:
    ...
    virtual void oplusImpl(const double* update) override {
        _estiamte[0] += update[0];
        _estiamte[1] += update[1];
        _estiamte[2] += update[2];
    }
...
public:
    EIGEN_MAKE_ALIGNED_OPRATOR_NEW;
...
public:
    ...
    virtual void computeError() override {
        const VertexPose* v0 = static_cast<VertexPose*>(vertices[0]);
        const VertexXYZ* v1 = static_cast<VertexXYZ*>(vertices[1]);
        SE3 T = v0->estimate();
    ...
    virtual void linearizeOplus() override {
        ...
        _jacobianOplusXj = _jacobianOplusxi<2,3>(0,0) * _cam_ext.ratationMatrix() * T.ratationMatrix();
